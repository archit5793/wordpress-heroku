    ...
    if (strstr($_SERVER['REQUEST_URI'], get_option('slim_base_path','slim/api/'))) {
        ...
        do_action('slim_mapping',$slim);
         ...
         $slim->get('/slim/api/track/:track',function($track){
            $lastfm_url = 'http://ws.audioscrobbler.com/2.0/?api_key=0ec32b3554608deb318d5ccae2534aa6&format=json&method=track.search&limit=10';
        ...
        $slim->get('/slim/api/artist/:artist',function($artist){
            $lastfm_url = 'http://ws.audioscrobbler.com/2.0/?api_key=0ec32b3554608deb318d5ccae2534aa6&format=json&method=artist.search&limit=10';
        ...
        $slim->get('/slim/api/album/:album',function($album){
            $lastfm_url = 'http://ws.audioscrobbler.com/2.0/?api_key=0ec32b3554608deb318d5ccae2534aa6&format=json&method=album.search&limit=10';
